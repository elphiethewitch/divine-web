...
// ABOUTME: Handles NIP-71 videos (kind 34236) and Kind 6 reposts with proper parsing
...
/**
 * Validates that a NIP-71 video event (kind 34236) has required fields
 */
  ...
  for (const repost of repostEvents) {
    ...
    if (!videoData) {
      ...
      videoData = {
        ...
        kind: originalVideo.kind as 34236,
