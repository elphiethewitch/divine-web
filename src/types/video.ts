...
// ABOUTME: Defines the structure of NIP-71 video events (kind 34236) and related metadata

import type { NostrEvent } from '@nostrify/nostrify';

// NIP-71 Video Event Kind
export const VIDEO_KIND = 34236; // NIP-71 Addressable short videos

// Array of all supported video kinds (currently only one)
...
export interface ParsedVideoData {
  ...
  kind: typeof VIDEO_KIND;   // NIP-71 video kind (34236)
  createdAt: number;
